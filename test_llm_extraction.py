...
def test_llm_extraction():
    ...
    test_cases = [
        ...
        {
            "message": "Salut ! J'ai 19 ans, je suis étudiant en informatique. Je n'ai pas de garant mais j'ai la garantie visale et je peux emménager en février pour 8 mois.",
